...
insert  into `anggota`(`anggota_id`,`nama`,`alamat`,`email`,`telepon`) values (113,'alfin','kaliaman','pcok071@gmail.com','087938383383'),(123,'alfin fr','jepara','pcok071@gmail.com','0957584t54');
...
CREATE TABLE `buku` (
  ...
  CONSTRAINT `buku_ibfk_2` FOREIGN KEY (`kategori_id`) REFERENCES `kategori` (`kategori_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1130 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `buku` */

insert  into `buku`(`buku_id`,`judul`,`pengarang`,`penerbit`,`tahun_terbit`,`sinopsis`,`kategori_id`) values (1127,'dongeng','alfin','unisnu',2022,'kopi pait',NULL),(1128,'sembarang','alfin','unisnu',2019,'hfngccf',NULL);
...
insert  into `kategori`(`kategori_id`,`nama_kategori`) values (67,'agsgsg');
...
CREATE TABLE `peminjaman` (
  ...
  `status` enum('dipinjam','kembali') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'dipinjam',
...
) ENGINE=InnoDB AUTO_INCREMENT=11035 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `peminjaman` */

insert  into `peminjaman`(`peminjaman_id`,`buku_id`,`anggota_id`,`tanggal_peminjaman`,`tanggal_kembali`,`status`) values (11019,1127,113,'2023-12-18','2023-12-19','dipinjam');
...
) ENGINE=InnoDB AUTO_INCREMENT=44445 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `pengembalian` */

insert  into `pengembalian`(`pengembalian_id`,`peminjaman_id`,`tanggal_pengembalian`,`denda`,`status_pengembalian`) values (44443,11019,'2023-12-20',60000.00,'dikembalikan');
